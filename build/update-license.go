...
var (
	...
	ethereumDir = map[string]string{
		...
		"cmd/klay/genesis_test.go":                         "cmd/geth/genesis_test.go",
		"cmd/klay/chaincmd.go":                             "cmd/geth/chaincmd.go",
		"cmd/klay/config.go":                               "cmd/geth/config.go",
		"cmd/klay/consolecmd.go":                           "cmd/geth/consolecmd.go",
		"cmd/klay/consolecmd_test.go":                      "cmd/geth/consolecmd_test.go",
		"cmd/klay/versioncmd.go":                           "cmd/geth/misccmd.go",
		"cmd/klay/accountcmd_test.go":                      "cmd/geth/accountcmd_test.go",
		"cmd/klay/run_test.go":                             "cmd/geth/run_test.go",
		"cmd/klay/accountcmd.go":                           "cmd/geth/accountcmd.go",
		"cmd/klay/main.go":                                 "cmd/geth/main.go",
		"cmd/bootnode/boootnode.go":                        "cmd/bootnode/main.go",
		...
		"cmd/cmdtest/test_cmd.go":                          "cmd/cmdtest/test_cmd.go",
		...
		"consensus/errors.go":                              "consensus/errors.go",
		...
		"api/api.go":                                       "internal/ethapi/api.go",
		...
		"client/klayclient.go":                             "ethclient/ethclient.go",
		"client/klayclient_test.go":                        "ethclient/ethclient_test.go",
