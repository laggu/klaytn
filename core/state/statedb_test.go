...
// Updating a state trie without commit must not affect persistent DB.
...
func TestIntermediateLeaks(t *testing.T) {
	...
	transDb := gxdb.NewMemDatabase()
	finalDb := gxdb.NewMemDatabase()
...
func TestCopy(t *testing.T) {
	...
	orig, _ := New(common.Hash{}, NewDatabase(gxdb.NewMemDatabase()))
...
func (test *snapshotTest) run() bool {
	...
	var (
		state, _     = New(common.Hash{}, NewDatabase(gxdb.NewMemDatabase()))
...
func TestCopyOfCopy(t *testing.T) {
	sdb, _ := New(common.Hash{}, NewDatabase(gxdb.NewMemDatabase()))
