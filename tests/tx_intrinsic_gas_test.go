...
// TestFeeDelegatedTransactionGasWithMultiSigAndLegacyPayer checks gas calculations
// using AccountKeyWeightedMultiSig sender and AccountKeyLegacy fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithMultiSigAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
...
// TestFeeDelegatedTransactionGasWithMultiSigAndPublicPayer checks gas calculations
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithMultiSigAndPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
...
// TestFeeDelegatedTransactionGasWithMultiSigAndMultiSigPayer checks gas calculations
// using AccountKeyWeightedMultiSig sender and AccountKeyWeightedMultiSig fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithMultiSigAndMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
	...
	newAddr, err := common.FromHumanReadableAddress("multiSigPayer")
	assert.Equal(t, nil, err)

	multiSigPayer, err := createMultisigAccount(uint(2),
		[]uint{1, 1},
		[]string{"98275a145bc1726eb0445433088f5f882f8a4a9499135239cfb4040e78991dab",
			"c64f2cd1196e2a1791365b00c4bc07ab8f047b73152e4617c6ed06ac221a4b0c"}, newAddr)
	...
	// Preparing step. Create a multiSig account for fee payer.
	{
		...
		values := map[types.TxValueKeyType]interface{}{
			types.TxValueKeyNonce:         reservoir.Nonce,
			types.TxValueKeyFrom:          reservoir.Addr,
			types.TxValueKeyTo:            multiSigPayer.Addr,
			types.TxValueKeyAmount:        amount,
			types.TxValueKeyGasLimit:      gasLimit,
			types.TxValueKeyGasPrice:      gasPrice,
			types.TxValueKeyHumanReadable: false,
			types.TxValueKeyAccountKey:    multiSigPayer.AccKey,
		}
		tx, err := types.NewTransactionWithMap(types.TxTypeAccountCreation, values)
		assert.Equal(t, nil, err)
	...
	// 1. TxTypeFeeDelegatedValueTransfer
	{
		values := map[types.TxValueKeyType]interface{}{
			...
			types.TxValueKeyGasLimit: gasLimit,
			types.TxValueKeyGasPrice: gasPrice,
			types.TxValueKeyFeePayer: multiSigPayer.Addr,
		}
		tx, err := types.NewTransactionWithMap(types.TxTypeFeeDelegatedValueTransfer, values)
		assert.Equal(t, nil, err)
		...
		err = tx.SignFeePayerWithKeys(signer, multiSigPayer.Keys)
		assert.Equal(t, nil, err)
		...
		intrinsicGas := params.TxGas + params.TxGasFeeDelegated
		gasFrom := params.TxValidationGasDefault + uint64(len(multisig.Keys))*params.TxValidationGasPerKey
		gasFeePayer := params.TxValidationGasDefault + uint64(len(multiSigPayer.Keys))*params.TxValidationGasPerKey
	...
	// 4. TxTypeFeeDelegatedAccountUpdate
	{
		...
		newMultiSig, err := createMultisigAccount(uint(2),
			[]uint{1, 1},
			[]string{"c64f2cd1196e2a1791365b00c4bc07ab8f047b73152e4617c6ed06ac221a4b0c",
				"98275a145bc1726eb0445433088f5f882f8a4a9499135239cfb4040e78991dab"}, newAddr)
		assert.Equal(t, nil, err)
...
// TestFeeDelegatedTransactionGasWithMultiSigAndRoleBasedWithPublicPayer checks gas calculations
// using AccountKeyWeightedMultiSig sender and AccountKeyRoleBased with AccountKeyPublic fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithMultiSigAndRoleBasedWithPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
...
// TestFeeDelegatedTransactionGasWithMultiSigAndRoleBasedWithMultiSigPayer checks gas calculations
// using AccountKeyWeightedMultiSig sender and AccountKeyRoleBased with AccountKeyWeightedMultiSig fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithMultiSigAndRoleBasedWithMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
