...
// TestFeeDelegatedWithRatioTransactionGasWithLegacyAndLegacyPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithLegacyAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
