...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithMultiSigAndMultiSigPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithMultiSigAndMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	// Preparing step. Create an AccountKeyWeightedMultiSig.
	{
