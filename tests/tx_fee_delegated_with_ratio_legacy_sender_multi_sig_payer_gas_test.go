...
// TestFeeDelegatedWithRatioTransactionGasWithLegacyAndMultiSigPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithLegacyAndMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
