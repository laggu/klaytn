...
// TestFeeDelegatedTransactionGasWithKlaytnLegacyAndRoleBasedWithMultiSigPayer checks gas calculations
// using KlaytnAccount with AccountKeyLegacy sender and AccountKeyRoleBased with AccountKeyWeightedMultiSig fee payer
...
func TestFeeDelegatedTransactionGasWithKlaytnLegacyAndRoleBasedWithMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
