...
// TestFeeDelegatedWithRatioTransactionGasWithMultiSigAndMultiSigPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithMultiSigAndMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	multiSigPayerAddr, err := common.FromHumanReadableAddress("multiSigPayer")
	...
	multiSigPayer, err := createMultisigAccount(uint(2),
		...
		[]string{"98275a145bc1726eb0445433088f5f882f8a4a9499135239cfb4040e78991dab",
			"c64f2cd1196e2a1791365b00c4bc07ab8f047b73152e4617c6ed06ac221a4b0c"}, multiSigPayerAddr)
	...
	// Preparing step. Create an AccountKeyWeightedMultiSig for feePayer.
	{
		var txs types.Transactions
