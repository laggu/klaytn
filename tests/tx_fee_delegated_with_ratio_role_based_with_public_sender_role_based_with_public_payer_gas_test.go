...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndRoleBasedWithPublicPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndRoleBasedWithPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	// Preparing step. Create an AccountKeyRoleBased with AccountKeyPublic for feePayer.
	{
		var txs types.Transactions
