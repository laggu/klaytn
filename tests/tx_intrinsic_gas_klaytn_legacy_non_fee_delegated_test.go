...
func TestTransactionGasWithKlaytnLegacy(t *testing.T) {
	...
	// klaytnLegacy account
	klaytnLegacy, err := createAnonymousAccount("c64f2cd1196e2a1791365b00c4bc07ab8f047b73152e4617c6ed06ac221a4b0c")
	assert.Equal(t, nil, err)
	...
	if testing.Verbose() {
		...
		fmt.Println("klaytnLegacyAddr = ", klaytnLegacy.Addr.String())
	}
	...
	// 5. TxTypeAccountCreation
	{
		...
		gasKey := params.TxAccountCreationGasDefault
