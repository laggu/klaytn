...
// TestFeeDelegatedTransactionGasWithKlaytnLegacyAndPublicPayer checks gas calculations
...
func TestFeeDelegatedTransactionGasWithKlaytnLegacyAndPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
