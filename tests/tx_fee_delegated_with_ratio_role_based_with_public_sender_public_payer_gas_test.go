...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndPublicPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	// Preparing step. Create an AccountKeyPublic for feePayer.
	{
		var txs types.Transactions
