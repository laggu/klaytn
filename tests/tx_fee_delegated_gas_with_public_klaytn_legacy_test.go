...
// TestFeeDelegatedTransactionGasWithPublicAndKlaytnLegacyPayer checks gas calculations
...
func TestFeeDelegatedTransactionGasWithPublicAndKlaytnLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	// Preparing step. Create an KlaytnAccount with AccountKeyLegacy.
	{
