...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithMultiSigAndLegacyPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithMultiSigAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
