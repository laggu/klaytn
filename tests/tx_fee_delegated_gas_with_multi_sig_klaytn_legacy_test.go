...
// TestFeeDelegatedTransactionGasWithMultiSigAndKlaytnLegacyPayer checks gas calculations
...
func TestFeeDelegatedTransactionGasWithMultiSigAndKlaytnLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
