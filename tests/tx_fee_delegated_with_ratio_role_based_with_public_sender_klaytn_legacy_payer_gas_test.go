...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndKlaytnLegacyPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndKlaytnLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	// Preparing step. Create a KlaytnAccount with AccountKeyLegacy for feePayer.
	{
		var txs types.Transactions
