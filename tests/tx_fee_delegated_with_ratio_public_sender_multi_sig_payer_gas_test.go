...
// TestFeeDelegatedWithRatioTransactionGasWithPublicAndMultiSigPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithPublicAndMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
