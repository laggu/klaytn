...
// TestFeeDelegatedTransactionGasWithKlaytnLegacyAndLegacyPayer checks gas calculations
...
func TestFeeDelegatedTransactionGasWithKlaytnLegacyAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
