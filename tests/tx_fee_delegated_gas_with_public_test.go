...
// TestFeeDelegatedTransactionGasWithPublicAndLegacyPayer checks gas calculations
// using AccountKeyPublic sender and AccountKeyLegacy fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedTransactionGasWithPublicAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	// 1. TxTypeFeeDelegatedValueTransfer
	{
		...
		// TODO-Klaytn-Gas gas fee should not be paid additionally for legacy accounts.
...
// TestFeeDelegatedTransactionGasWithPublicAndPublicPayer checks gas calculations
// using AccountKeyPublic sender and AccountKeyPublic fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithPublicAndPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
	...
	jasmine, err := createHumanReadableAccount("c32c471b732e2f56103e2f8e8cfd52792ef548f05f326e546a7d1fbf9d0419ec", "jasmine")
	assert.Equal(t, nil, err)
	...
	// Preparing step. Create an account jasmine.
	{
		var txs types.Transactions
		...
		values := map[types.TxValueKeyType]interface{}{
			types.TxValueKeyNonce:         reservoir.Nonce,
			types.TxValueKeyFrom:          reservoir.Addr,
			types.TxValueKeyTo:            jasmine.Addr,
			types.TxValueKeyAmount:        amount,
			types.TxValueKeyGasLimit:      gasLimit,
			types.TxValueKeyGasPrice:      gasPrice,
			types.TxValueKeyHumanReadable: false,
			types.TxValueKeyAccountKey:    jasmine.AccKey,
		}
		tx, err := types.NewTransactionWithMap(types.TxTypeAccountCreation, values)
		assert.Equal(t, nil, err)
	...
	// 1. TxTypeFeeDelegatedValueTransfer
	{
		values := map[types.TxValueKeyType]interface{}{
			...
			types.TxValueKeyGasLimit: gasLimit,
			types.TxValueKeyGasPrice: gasPrice,
			types.TxValueKeyFeePayer: jasmine.Addr,
		}
		tx, err := types.NewTransactionWithMap(types.TxTypeFeeDelegatedValueTransfer, values)
		assert.Equal(t, nil, err)
		...
		err = tx.SignFeePayerWithKeys(signer, jasmine.Keys)
		assert.Equal(t, nil, err)
...
// TestFeeDelegatedTransactionGasWithPublicAndMultiSigPayer checks gas calculations
// using AccountKeyPublic sender and AccountKeyWeightedMultiSig fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithPublicAndMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
...
// TestFeeDelegatedTransactionGasWithPublicAndRoleBasedWithPublicPayer checks gas calculations
// using AccountKeyPublic sender and AccountKeyRoleBased with AccountKeyPublic fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithPublicAndRoleBasedWithPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
	...
	// Preparing step. Create a roleBased account.
	{
		var txs types.Transactions
...
// TestFeeDelegatedTransactionGasWithPublicAndRoleBasedWithMultiSigPayer checks gas calculations
// using AccountKeyPublic sender and AccountKeyRoleBased with AccountKeyWeightedMultiSig fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithPublicAndRoleBasedWithMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
