...
// TestFeeDelegatedWithRatioTransactionGasWithMultiSigAndLegacyPayer checks gas calculations of fee delegated with ratio transaction
// using AccountKeyWeightedMultiSig sender and LegacyAccount fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedWithRatioTransactionGasWithMultiSigAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
