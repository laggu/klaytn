...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithMultiSigAndKlaytnLegacyPayer checks gas calculations of fee delegated with ratio transaction
// using AccountKeyRoleBased with AccountKeyWeightedMultiSig sender and KlaytnAccount with AccountKeyLegacy fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithMultiSigAndKlaytnLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
