...
// TestFeeDelegatedWithRatioTransactionGasWithKlaytnLegacyAndPublicPayer checks gas calculations of fee delegated with ratio transaction
// using KlaytnAccount with AccountKeyLegacy sender and AccountKeyPublic fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedWithRatioTransactionGasWithKlaytnLegacyAndPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
