...
// TestFeeDelegatedWithRatioTransactionGasWithKlaytnLegacyAndRoleBasedWithPublicPayer checks gas calculations of fee delegated with ratio transaction
// using KlaytnAccount with AccountKeyLegacy sender and AccountKeyRoleBased with AccountKeyPublic fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedWithRatioTransactionGasWithKlaytnLegacyAndRoleBasedWithPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
