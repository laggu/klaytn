...
// TestFeeDelegatedWithRatioTransactionGasWithMultiSigAndRoleBasedWithMultiSigPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithMultiSigAndRoleBasedWithMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
