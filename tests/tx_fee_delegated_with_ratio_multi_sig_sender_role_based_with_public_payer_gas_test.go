...
// TestFeeDelegatedWithRatioTransactionGasWithMultiSigAndRoleBasedWithPublicPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithMultiSigAndRoleBasedWithPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
