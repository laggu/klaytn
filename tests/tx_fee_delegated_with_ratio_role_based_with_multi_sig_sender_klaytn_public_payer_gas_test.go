...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithMultiSigAndPublicPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithMultiSigAndPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	// Preparing step. Create a AccountKeyPublic.
	{
