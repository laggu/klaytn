...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithMultiSigAndRoleBasedWithPublicPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithMultiSigAndRoleBasedWithPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	// Preparing step. Create an AccountKeyRoleBased with AccountKeyPublic.
	{
