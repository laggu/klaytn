...
// TestFeeDelegatedWithRatioTransactionGasWithLegacyAndRoleBasedWithPublicPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithLegacyAndRoleBasedWithPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
