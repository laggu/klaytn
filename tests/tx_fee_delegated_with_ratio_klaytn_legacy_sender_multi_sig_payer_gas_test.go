...
// TestFeeDelegatedWithRatioTransactionGasWithKlaytnLegacyAndMultiSigPayer checks gas calculations of fee delegated with ratio transaction
// using KlaytnAccount with AccountKeyLegacy sender and AccountKeyWeightedMultiSig fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedWithRatioTransactionGasWithKlaytnLegacyAndMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
