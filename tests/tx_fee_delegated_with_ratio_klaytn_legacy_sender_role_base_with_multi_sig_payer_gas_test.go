...
// TestFeeDelegatedWithRatioTransactionGasWithKlaytnLegacyAndRoleBasedWithMultiSigPayer checks gas calculations of fee delegated with ratio transaction
// using KlaytnAccount with AccountKeyLegacy sender and AccountKeyRoleBased with AccountKeyWeightedMultiSig fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedWithRatioTransactionGasWithKlaytnLegacyAndRoleBasedWithMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
