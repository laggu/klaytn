...
// TestFeeDelegatedTransactionGasWithRoleBasedWithPublicAndLegacyPayer checks gas calculations
// using AccountKeyRoleBased with AccountKeyPublic sender and AccountKeyLegacy fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedTransactionGasWithRoleBasedWithPublicAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
...
// TestFeeDelegatedTransactionGasWithRoleBasedWithPublicAndPublicPayer checks gas calculations
// using AccountKeyRoleBased with AccountKeyPublic sender and AccountKeyPublic fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithRoleBasedWithPublicAndPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
...
// TestFeeDelegatedTransactionGasWithRoleBasedWithPublicAndMultiSigPayer checks gas calculations
// using AccountKeyRoleBased with AccountKeyPublic sender and AccountKeyWeightedMultiSig fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithRoleBasedWithPublicAndMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
	...
	// Preparing step. Create a role based with accountKeyWeightedMultiSig account.
	{
		var txs types.Transactions
...
// TestFeeDelegatedTransactionGasWithRoleBasedWithPublicAndMultiSigPayer checks gas calculations
// using AccountKeyRoleBased with AccountKeyPublic sender and AccountKeyRoleBased with AccountKeyPublic fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithRoleBasedWithPublicAndRoleBasedWithPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
	...
	// role based account
	roleBasedPayer, err := createRoleBasedAccountWithAccountKeyPublic(
		[]string{"bb113e82881499a7a361e8354a5b68f6c6885c7bcba09ea2b0891480396c322e",
			"a5c9a50938a089618167c9d67dbebc0deaffc3c76ddc6b40c2777ae59438e989",
			"c32c471b732e2f56103e2f8e8cfd52792ef548f05f326e546a7d1fbf9d0419ec"}, roleBasedPayerAddr)
	assert.Equal(t, nil, err)
	...
	// Preparing step. Create a role based with accountKeyRoleBased with AccountKeyPublic account.
	{
		var txs types.Transactions
...
// TestFeeDelegatedTransactionGasWithRoleBasedWithPublicAndRoleBasedWithMultiSigPayer checks gas calculations
// using AccountKeyRoleBased with AccountKeyPublic sender and AccountKeyRoleBased with AccountKeyWeightedMultiSig fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithRoleBasedWithPublicAndRoleBasedWithMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
	...
	roleBasedPayer, err := createRoleBasedAccountWithAccountKeyWeightedMultiSig(
		[]TestCreateMultisigAccountParam{param1, param2, param3}, roleBasedPayerAddr)
	assert.Equal(t, nil, err)
	...
	// Preparing step. Create a role based with accountKeyRoleBased with AccountKeyWeightedMultiSig account.
	{
		var txs types.Transactions
	...
	// 1. TxTypeFeeDelegatedValueTransfer
	{
		...
		// TODO-Klaytn-Gas Gas calculation logic has to be changed to calculate only the gas value for the key used in signing.
		sigValidationGasWithTxKeys := params.TxValidationGasDefault + uint64(len(roleBasedPayer.TxKeys))*params.TxValidationGasPerKey
		sigValidationGasWithUpdateKeys := params.TxValidationGasDefault + uint64(len(roleBasedPayer.UpdateKeys))*params.TxValidationGasPerKey
		sigValidationGasWithFeeKeys := params.TxValidationGasDefault + uint64(len(roleBasedPayer.FeeKeys))*params.TxValidationGasPerKey
