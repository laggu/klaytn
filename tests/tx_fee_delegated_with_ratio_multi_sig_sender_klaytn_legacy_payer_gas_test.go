...
// TestFeeDelegatedWithRatioTransactionGasWithMultiSigAndKlaytnLegacyPayer checks gas calculations of fee delegated with ratio transaction
// using AccountKeyWeightedMultiSig sender and KlaytnAccount with AccountKeyLegacy fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedWithRatioTransactionGasWithMultiSigAndKlaytnLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
