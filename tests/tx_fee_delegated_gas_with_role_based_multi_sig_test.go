...
// TestFeeDelegatedTransactionGasWithRoleBasedWithMultiSigAndLegacyPayer checks gas calculations
// using AccountKeyRoleBased with AccountKeyWeightedMultiSig sender and AccountKeyLegacy fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedTransactionGasWithRoleBasedWithMultiSigAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
...
// TestFeeDelegatedTransactionGasWithRoleBasedWithMultiSigAndPublicPayer checks gas calculations
// using AccountKeyRoleBased with AccountKeyWeightedMultiSig sender and AccountKeyPublic fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithRoleBasedWithMultiSigAndPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
...
// TestFeeDelegatedTransactionGasWithRoleBasedWithMultiSigAndMultiSigPayer checks gas calculations
// using AccountKeyRoleBased with AccountKeyWeightedMultiSig sender and AccountKeyWeightedMultiSig fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithRoleBasedWithMultiSigAndMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
	...
	// Preparing step. Create a role based account.
	{
		var txs types.Transactions
...
// TestFeeDelegatedTransactionGasWithRoleBasedWithMultiSigAndRoleBasedWithPublicPayer checks gas calculations
// using AccountKeyRoleBased with AccountKeyWeightedMultiSig sender and AccountKeyRoleBased with AccountKeyPublic fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithRoleBasedWithMultiSigAndRoleBasedWithPublicPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
	...
	// get humanreadable address for role based account
	roleBasedPublicAddr, err := common.FromHumanReadableAddress("roleBasedPublicAddr")
	assert.Equal(t, nil, err)

	// role based account
	roleBasedPublic, err := createRoleBasedAccountWithAccountKeyPublic(
		[]string{"41bd2b972564206658eab115f26ff4db617e6eb39c81a557adc18d8305d2f867",
			"98275a145bc1726eb0445433088f5f882f8a4a9499135239cfb4040e78991dab",
			"c64f2cd1196e2a1791365b00c4bc07ab8f047b73152e4617c6ed06ac221a4b0c"}, roleBasedPublicAddr)
	assert.Equal(t, nil, err)
	...
	// Preparing step. Create a role based with public account.
	{
		var txs types.Transactions
		...
		values := map[types.TxValueKeyType]interface{}{
			types.TxValueKeyNonce:         reservoir.Nonce,
			types.TxValueKeyFrom:          reservoir.Addr,
			types.TxValueKeyTo:            roleBasedPublic.Addr,
			types.TxValueKeyAmount:        amount,
			types.TxValueKeyGasLimit:      gasLimit,
			types.TxValueKeyGasPrice:      gasPrice,
			types.TxValueKeyHumanReadable: false,
			types.TxValueKeyAccountKey:    roleBasedPublic.AccKey,
		}
		tx, err := types.NewTransactionWithMap(types.TxTypeAccountCreation, values)
		assert.Equal(t, nil, err)
	...
	// 1. TxTypeFeeDelegatedValueTransfer
	{
		values := map[types.TxValueKeyType]interface{}{
			...
			types.TxValueKeyGasLimit: gasLimit,
			types.TxValueKeyGasPrice: gasPrice,
			types.TxValueKeyFeePayer: roleBasedPublic.Addr,
		}
		tx, err := types.NewTransactionWithMap(types.TxTypeFeeDelegatedValueTransfer, values)
		assert.Equal(t, nil, err)
		...
		err = tx.SignFeePayerWithKeys(signer, roleBasedPublic.FeeKeys)
		assert.Equal(t, nil, err)
...
// TestFeeDelegatedTransactionGasWithRoleBasedWithMultiSigAndRoleBasedWithMultiSigPayer checks gas calculations
// using AccountKeyRoleBased with AccountKeyWeightedMultiSig sender and AccountKeyRoleBased with AccountKeyWeightedMultiSig fee payer for fee delegated transaction types such as:
// 1. TxTypeFeeDelegatedValueTransfer
// 2. TxTypeFeeDelegatedValueTransferMemo with non-zero values.
// 3. TxTypeFeeDelegatedValueTransferMemo with zero values.
// 4. TxTypeFeeDelegatedAccountUpdate
...
// 6. TxTypeFeeDelegatedSmartContractExecution
// 7. TxTypeFeeDelegatedCancel
func TestFeeDelegatedTransactionGasWithRoleBasedWithMultiSigAndRoleBasedWithMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	prof := profile.NewProfiler()
	...
	// get humanreadable address for role based account
	roleBasedPayerAddr, err := common.FromHumanReadableAddress("roleBasedPayerAddr")
	assert.Equal(t, nil, err)

	// role based account
	roleBasedPayer, err := createRoleBasedAccountWithAccountKeyWeightedMultiSig(
		[]TestCreateMultisigAccountParam{param2, param1, param3}, roleBasedPayerAddr)
	assert.Equal(t, nil, err)
	...
	// Preparing step. Create a role based with multiSig account.
	{
		var txs types.Transactions
		...
		values := map[types.TxValueKeyType]interface{}{
			types.TxValueKeyNonce:         reservoir.Nonce,
			types.TxValueKeyFrom:          reservoir.Addr,
			types.TxValueKeyTo:            roleBasedPayer.Addr,
			types.TxValueKeyAmount:        amount,
			types.TxValueKeyGasLimit:      gasLimit,
			types.TxValueKeyGasPrice:      gasPrice,
			types.TxValueKeyHumanReadable: false,
			types.TxValueKeyAccountKey:    roleBasedPayer.AccKey,
		}
		tx, err := types.NewTransactionWithMap(types.TxTypeAccountCreation, values)
		assert.Equal(t, nil, err)
	...
	// 1. TxTypeFeeDelegatedValueTransfer
	{
		values := map[types.TxValueKeyType]interface{}{
			...
			types.TxValueKeyGasLimit: gasLimit,
			types.TxValueKeyGasPrice: gasPrice,
			types.TxValueKeyFeePayer: roleBasedPayer.Addr,
		}
		tx, err := types.NewTransactionWithMap(types.TxTypeFeeDelegatedValueTransfer, values)
		assert.Equal(t, nil, err)
		...
		err = tx.SignFeePayerWithKeys(signer, roleBasedPayer.FeeKeys)
		assert.Equal(t, nil, err)
		...
		// TODO-Klaytn-Gas Gas calculation logic has to be changed to calculate only the gas value for the key used in signing.
		sigValidationGasWithTxKeysForPayer := params.TxValidationGasDefault + uint64(len(roleBasedPayer.TxKeys))*params.TxValidationGasPerKey
		sigValidationGasWithUpdateKeysForPayer := params.TxValidationGasDefault + uint64(len(roleBasedPayer.UpdateKeys))*params.TxValidationGasPerKey
		sigValidationGasWithFeeKeysForPayer := params.TxValidationGasDefault + uint64(len(roleBasedPayer.FeeKeys))*params.TxValidationGasPerKey
		gasFeePayer := sigValidationGasWithTxKeysForPayer + sigValidationGasWithUpdateKeysForPayer + sigValidationGasWithFeeKeysForPayer
