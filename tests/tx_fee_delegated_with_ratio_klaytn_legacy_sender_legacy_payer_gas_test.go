...
// TestFeeDelegatedWithRatioTransactionGasWithKlaytnLegacyAndLegacyPayer checks gas calculations of fee delegated with ratio transaction
// using KlaytnAccount with AccountKeyLegacy sender and AccountKeyLegacy fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedWithRatioTransactionGasWithKlaytnLegacyAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
