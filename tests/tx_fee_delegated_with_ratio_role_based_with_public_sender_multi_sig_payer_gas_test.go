...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndMultiSigPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
