...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndRoleBasedWithMultiSigPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndRoleBasedWithMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	// Preparing step. Create an AccountKeyRoleBased with AccountKeyPublic for sender.
	{
	...
	// Preparing step. Create an AccountKeyRoleBased with AccountKeyWeightedMultiSig for feePayer.
	{
		var txs types.Transactions
	...
	// 4. TxTypeFeeDelegatedAccountUpdateWithRatio
	{
		...
		newRoleBased, err := createRoleBasedAccountWithAccountKeyPublic(
			[]string{"c32c471b732e2f56103e2f8e8cfd52792ef548f05f326e546a7d1fbf9d0419ec",
				...
				"a5c9a50938a089618167c9d67dbebc0deaffc3c76ddc6b40c2777ae59438e989"}, newAddr)
		assert.Equal(t, nil, err)
