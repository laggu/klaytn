...
// TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndLegacyPayer checks gas calculations of fee delegated with ratio transaction
// using AccountKeyRoleBased with AccountKeyPublic sender and LegacyAccount fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedWithRatioTransactionGasWithRoleBasedWithPublicAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
