...
// TestFeeDelegatedWithRatioTransactionGasWithLegacyAndRoleBasedWithMultiSigPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithLegacyAndRoleBasedWithMultiSigPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
	...
	// Preparing step. Create a AccountKeyRoleBased with AccountKeyPublic.
	{
