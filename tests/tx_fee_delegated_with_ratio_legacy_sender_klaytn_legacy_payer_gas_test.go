...
// TestFeeDelegatedWithRatioTransactionGasWithLegacyAndKlaytnLegacyPayer checks gas calculations of fee delegated with ratio transaction
// using AccountKeyLegacy sender and KlaytnAccount with AccountKeyLegacy fee payer for fee delegated transaction types such as:
...
func TestFeeDelegatedWithRatioTransactionGasWithLegacyAndKlaytnLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
