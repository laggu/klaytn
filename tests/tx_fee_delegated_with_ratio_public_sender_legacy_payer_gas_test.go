...
// TestFeeDelegatedWithRatioTransactionGasWithPublicAndLegacyPayer checks gas calculations of fee delegated with ratio transaction
...
func TestFeeDelegatedWithRatioTransactionGasWithPublicAndLegacyPayer(t *testing.T) {
	if testing.Verbose() {
		enableLog()
	}
