...
func NewAddressBookManager(bc *blockchain.BlockChain) *AddressBookManager {
...
func (abm *AddressBookManager) getStakingInfoFromAddressBook(blockNum uint64) (*StakingInfo, error) {
	...
	if err != nil {
		...
		return newEmptyStakingInfo(abm.bc, blockNum)
	}

	return newStakingInfo(abm.bc, blockNum, nodeIds, stakingAddrs, rewardAddrs, KIRAddr, PoCAddr)
}
