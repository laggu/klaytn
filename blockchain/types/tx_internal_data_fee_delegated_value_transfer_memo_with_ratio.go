...
func (t *TxInternalDataFeeDelegatedValueTransferMemoWithRatio) IntrinsicGas() (uint64, error) {
	gasPayload, err := intrinsicGasPayload(t.Payload)
	if err != nil {
		return 0, err
	}

	return params.TxGas + gasPayload + params.TxGasFeeDelegatedWithRatio, nil
}
