...
func WriteTxLookupEntries(db DatabaseWriter, block *types.Block) error {
...
func ReadBloomBits(db DatabaseReader, bloomBitsKey []byte) ([]byte, error) {
	return db.Get(bloomBitsKey)
}

// WriteBloomBits stores the compressed bloom bits vector belonging to the given
// section and bit index.
func WriteBloomBits(db DatabaseWriter, bloomBitsKey, bits []byte) error {
