...
//func (mbh *MainBridgeHandler) writeServiceChainTxReceipts(bc *blockchain.BlockChain, receipts []*types.ReceiptForStorage) {
//	sentServiceChainTxs := mbh.sentServiceChainTxs
...
//			mbh.protocolHandler.removeServiceChainTx(txHash)
//		} else {
...
// transaction hash.
//func (mbh *MainBridgeHandler) removeServiceChainTx(txHash common.Hash) {
//	if _, ok := mbh.sentServiceChainTxs[txHash]; !ok {
//		logger.Error("ServiceChainTx does not exists in sentServiceChainTxs", "txHash", txHash)
//		return
//	}
//	delete(mbh.sentServiceChainTxs, txHash)
//}

// Handler for SubBridge
...
// writeServiceChainTxReceipt writes the received receipts of service chain transactions.
//func (mbh *SubBridgeHandler) writeServiceChainTxReceipts(bc *blockchain.BlockChain, receipts []*types.ReceiptForStorage) {
//	sentServiceChainTxs := mbh.sentServiceChainTxs
//	for _, receipt := range receipts {
//		txHash := receipt.TxHash
//		if tx, ok := sentServiceChainTxs[txHash]; ok {
...
//			}
//			bc.WriteReceiptFromParentChain(chainHashes.BlockHash, (*types.Receipt)(receipt))
//			mbh.removeServiceChainTx(txHash)
//		} else {
//			logger.Error("received service chain transaction receipt does not exist in sentServiceChainTxs", "txHash", txHash.String())
//		}
//
...
// removeServiceChainTx removes a transaction from SentServiceChainTxs with the given
// transaction hash.
//func (mbh *SubBridgeHandler) removeServiceChainTx(txHash common.Hash) {
//	if _, ok := mbh.sentServiceChainTxs[txHash]; !ok {
//		logger.Error("ServiceChainTx does not exists in sentServiceChainTxs", "txHash", txHash)
//		return
//	}
