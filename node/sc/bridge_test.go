...
// TestBridgeRequestHandleGasUsedTest tests the gas used of handle function which include a loop.
func TestBridgeRequestHandleGasUsedTest(t *testing.T) {
	...
	lowerHandleNonce, _ = b.LowerHandleNonce(nil)
	assert.Equal(t, uint64(700), lowerHandleNonce)
	upperHandleNonce, _ = b.UpperHandleNonce(nil)
	assert.Equal(t, uint64(999), upperHandleNonce)
}
