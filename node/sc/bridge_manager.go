...
// UpdateLowerHandledNonce updates the lower handle nonce.
...
func (bm *BridgeManager) LogBridgeStatus() {
	...
	p2cTotalRequestNonce, p2cTotalHandleNonce, p2cTotalLowerHandleNonce := uint64(0), uint64(0), uint64(0)
	c2pTotalRequestNonce, c2pTotalHandleNonce, c2pTotalLowerHandleNonce := uint64(0), uint64(0), uint64(0)
