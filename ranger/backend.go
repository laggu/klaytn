...
func (rn *Ranger) proofReplication() error {
	...
	//url := accounts.URL{"keystore","/Users/jun/data/istanbul/node6/keystore/UTC--2018-05-30T08-36-11.646393438Z--605c0b13afc58eb93088fda85cc6b9b94ce9c0d0"}

	account := accounts.Account{Address: coinbase}//,URL:url}
